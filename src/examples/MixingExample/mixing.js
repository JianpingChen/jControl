...
{ 
	...
	// find the place for text input
	var textInputDiv = j.containerElement(document.getElementById('textInputPlace'));
	// add text input to the place
	textInputDiv.add(helloworld);
	// find the place for text area
	var textAreaDiv = j.containerElement(document.getElementById('textAreaPlace'));
	// add text area to the place
	textAreaDiv.add(userInput);
